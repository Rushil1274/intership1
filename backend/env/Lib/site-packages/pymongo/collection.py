...
class Collection(common.BaseObject, Generic[_DocumentType]):
    ...
    def _conn_for_reads(
        ...
        return self.__database.client._conn_for_reads(
    ...
    def _insert_one(
        ...
        command = SON(
            [("insert", self.name), ("ordered", ordered), ("documents", [doc])]
        )
    ...
    def _update(
        ...
        command = SON(
            [("update", self.name), ("ordered", ordered), ("updates", [update_doc])]
        )
        if let is not None:
    ...
    def _delete(
        ...
        command = SON(
            [("delete", self.name), ("ordered", ordered), ("deletes", [delete_doc])]
        )
    ...
    def create_search_indexes(
        ...
        **kwargs: Any,
        ...
        cmd = SON(
            [("createSearchIndexes", self.name), ("indexes", list(gen_indexes()))]
        )
        cmd.update(kwargs)
