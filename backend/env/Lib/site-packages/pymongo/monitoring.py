...
class CommandStartedEvent(_CommandEvent):
    ...
    def __repr__(self) -> str:
        return (
            "<{} {} db: {!r}, command: {!r}, operation_id: {}, service_id: {}>"
        ).format(
...
class PoolClearedEvent(_PoolEvent):
    ...
    def __init__(
        self, address: _Address, service_id: Optional[ObjectId] = None
    ) -> None:
        super().__init__(address)
        self.__service_id = service_id
...
class _ServerHeartbeatEvent:
    ...
    def __repr__(self) -> str:
        return (
            f"<{self.__class__.__name__} {self.connection_id} awaited: {self.awaited}>"
        )
...
class _EventListeners:
    ...
    def publish_pool_cleared(
        self, address: _Address, service_id: Optional[ObjectId]
    ) -> None:
    ...
    def publish_connection_check_out_failed(
        self, address: _Address, reason: str
    ) -> None:
